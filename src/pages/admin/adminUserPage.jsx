							...
							return (
								...
								>
									...
									<td className="px-4 py-3 text-sm">
                                            ...
                                            onClick={
                                                async ()=>{
                                                    await axios.put(import.meta.env.VITE_BACKEND_URL + `/users/toggle-block/${item.email}`,{
                                                        isBlocked: !item.isBlocked //isBlocked eke opposite eka yawanna ona
                                                    },
                                                    {
                                                        headers: {  
                                                            Authorization: `Bearer ${localStorage.getItem("token")}`
                                        ...
                                        >
                                            {
                                                item.isBlocked?"Unblock User":"Block User" //user block nam button eka unblok kiyela display wenna nattan block kiyela display wenna.
                                            }
                                        </button>
                                    </td>
								</tr>
