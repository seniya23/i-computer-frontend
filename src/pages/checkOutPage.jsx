...
export default function CheckoutPage() {
	const location = useLocation(); //cart page eken ena data eka read kerenewa 
					...
					>
						...
						<div className="min-h-full flex flex-row items-center gap-4">
							<div className="h-full flex flex-col justify-center items-center">
								...
								<BsChevronUp
									onClick={() => {
                                        //cart ekedi item remove kerenewanam quantity eka 1k adu kerenawa
                                        const copiedCart = [...cart]; // useState eka direct modify karanna bari nisa cart eka copy karanawa, methena wenne shallow copy ekak, json ekak copy kerenewanam mehema // const copiedCart = {...cart}
										copiedCart[index].quantity -= 1;
										if (copiedCart[index].quantity < 1) {
											copiedCart.splice(index, 1); //quantity eka 0 unoth e item eka cart eken remove kerenawa
										}
										setCart(copiedCart);
									}}
